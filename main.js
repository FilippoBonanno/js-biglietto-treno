...
if (ages < 18) {
    ...
    document.getElementById("final-prize").innerText = `${ticketprize.toFixed(1)}€ Già scontato del 20%`;
    ...
    console.log( `Prezzo biglietto: ${ticketprize.toFixed(1)}€`);
    document.getElementById("final-prize").innerText = `${ticketprize.toFixed(1)}€ Già scontato del 40%`;
    ...
    console.log( `Prezzo biglietto: ${ticketprize.toFixed(1)}€`);
    document.getElementById("final-prize").innerText = `${ticketprize.toFixed(1)}€`;
